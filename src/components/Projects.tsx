    ...
    <section id="projects" className="w-full max-w-[1400px] mx-auto px-6 py-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-20">
        {highlightedProjects.map((project, index) => (
          <motion.div 
            key={index}
            className="flex flex-col h-full bg-white/70 dark:bg-white/10 backdrop-blur-2xl border border-white/40 dark:border-white/20 p-10 rounded-[2.5rem] shadow-md hover:shadow-xl hover:-translate-y-2 transition-all duration-500"
            variants={{
