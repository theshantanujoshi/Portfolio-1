...
const Experience: React.FC = () => {
 ...
 >
 <h2 className="text-4xl font-bold text-amber-200 tracking-tighter transition-colors duration-500">Experience</h2>
 ...
 <motion.div 
 key={index}
 className="relative flex items-start gap-8 bg-[#0f172a]/70 backdrop-blur-2xl border border-white/40 border-amber-900/30 p-8 md:p-12 rounded-[2.5rem] shadow-md hover:shadow-xl hover:-translate-y-2 transition-all duration-500"
 variants={{
 ...
 viewport={{ once: true, margin: "-50px" }}
 >
 <div className="hidden sm:flex shrink-0 w-16 h-16 bg-[#0f172a]/90 rounded-full shadow-sm items-center justify-center border border-amber-900/30 transition-colors duration-500">
 <Briefcase size={24} className="text-amber-200 transition-colors duration-500" />
 </div>
 <div className="flex-1">
 <h3 className="text-2xl font-bold text-amber-200 tracking-tight transition-colors duration-500">{exp.role}</h3>
 <div className="flex flex-col sm:flex-row sm:items-center justify-between mt-2 mb-6">
 <span className="text-lg text-amber-200/90 font-semibold opacity-95 transition-colors duration-500">@ {exp.company}</span>
 <span className="text-sm font-bold tracking-wider uppercase text-amber-200/80 opacity-90 bg-[#0f172a]/90 px-4 py-1.5 rounded-full border border-amber-900/30 mt-3 sm:mt-0 inline-block w-fit transition-colors duration-500">
 {exp.date}
 </span>
 </div>
 <ul className="list-disc list-inside space-y-3 text-lg font-medium text-amber-200/80 opacity-95 transition-colors duration-500">
