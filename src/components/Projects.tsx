      ...
      >
        ...
        {loading ? (
          <div className="flex flex-col items-center justify-center py-20 gap-4">
            ...
            <p className="text-sm font-bold tracking-widest uppercase text-black dark:text-white/70">Fetching Database</p>
          </div>
        ) : (
              ...
              >
                <Tilt rotationIntensity={10}>
                  ...
                  >
                    ...
                    <div style={{ transform: "translateZ(20px)" }} className="mt-12 flex items-center justify-between border-t border-black dark:border-white/10 group-hover:border-white dark:group-hover:border-black pt-6 transition-colors duration-500">
