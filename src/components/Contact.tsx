...
const Contact: React.FC = () => {
  return (
    <section id="contact" className="w-full max-w-[1400px] mx-auto px-6 py-10 pb-32">
      ...
      >
        <h2 className="text-4xl md:text-5xl font-bold text-[#5E6470] dark:text-white tracking-tighter mb-6 transition-colors duration-500">Get In Touch</h2>
        <p className="text-[#5E6470] dark:text-gray-200 opacity-95 mb-12 max-w-2xl leading-relaxed text-lg md:text-xl font-medium transition-colors duration-500">
        ...
        <div className="flex flex-col sm:flex-row gap-6 mb-14">
          <div className="flex items-center gap-4 bg-white/80 dark:bg-black/40 px-6 py-5 rounded-3xl border border-white/60 dark:border-white/20 shadow-sm transition-colors duration-500 hover:shadow-md">
            <Mail className="text-[#5E6470] dark:text-white" size={24} />
            <div className="text-left">
              <p className="text-xs font-bold text-[#5E6470] dark:text-gray-400 uppercase tracking-widest opacity-80 mb-1">Personal</p>
              <a href="mailto:wharshsingh@gmail.com" className="text-[#5E6470] dark:text-white font-semibold hover:text-black dark:hover:text-gray-300 transition-colors">wharshsingh@gmail.com</a>
            </div>
          </div>
          <div className="flex items-center gap-4 bg-white/80 dark:bg-black/40 px-6 py-5 rounded-3xl border border-white/60 dark:border-white/20 shadow-sm transition-colors duration-500 hover:shadow-md">
            <Mail className="text-[#5E6470] dark:text-white" size={24} />
            <div className="text-left">
              <p className="text-xs font-bold text-[#5E6470] dark:text-gray-400 uppercase tracking-widest opacity-80 mb-1">College</p>
              <a href="mailto:b24bs1154@iitj.ac.in" className="text-[#5E6470] dark:text-white font-semibold hover:text-black dark:hover:text-gray-300 transition-colors">b24bs1154@iitj.ac.in</a>
            </div>
          </div>
        </div>
        ...
        <a 
          ...
          className="inline-flex items-center gap-3 bg-[#5E6470] dark:bg-white text-white dark:text-black px-10 py-5 rounded-2xl text-lg font-bold hover:bg-black dark:hover:bg-gray-200 transition-all shadow-md hover:shadow-xl hover:-translate-y-1"
        >
          <Mail size={22} />
          <span>Say Hello</span>
        </a>
