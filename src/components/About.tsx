      ...
      >
        <div className="flex flex-col lg:flex-row gap-16 items-start">
          ...
          <div className="w-full lg:w-2/3 flex flex-col gap-10">
            ...
            <a href="https://linkedin.com/in/harsh-singh-b89925315/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 font-bold text-black dark:text-white uppercase tracking-widest hover:opacity-50 transition-opacity w-fit mt-4">
